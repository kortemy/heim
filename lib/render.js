class Render {
  ...
  async renderApp (app, parentId) {
    let grid = document.querySelector(`#${parentId}`)
    let markup = `  
      <div class="app uk-card uk-card-default uk-margin-left" style="margin-bottom: 20px !important"
        data-app='${btoa(app.id)}'>      
        <div class="uk-card-media-top uk-cover-container">
          <img src="${app.icon.url}" style="width: 64px; height: 64px; margin-top: 20px;" alt="" uk-cover>
        </div>
